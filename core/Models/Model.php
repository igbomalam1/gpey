<?php
	...
	class Model{
		...
		public static $dbName="dnkgaveh_gpey"; //Database Name
		public static $username="dnkgaveh_williams"; // Database Username
		public static $password="Oyom1983@#1"; //Database Password

        public static $dbh;
        
		public $emailUsername="support@gpeytelecom.com.ng"; //Support Email Address
		public $emailPassword="Oyom1983@#1"; //Support Email Password
