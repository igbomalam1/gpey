    ...
    <div class="col-12">
        ...
        <div class="box">
            ...
            <form  method="post" class="form-submit">
                    ...
                    <hr>
                    <h4 class="box-title">NIN / BVN API Settings (NINBVNPORTAL)</h4>
                    <div class="form-group">
                        <label class="control-label">NINBVNPORTAL API Key</label>
                        <div class="">
                        <input type="text" name="ninBvnApiKey" value="<?php echo $controller->getConfigValue($data[0],"ninBvnApiKey"); ?>" class="form-control" placeholder="Enter NINBVNPORTAL API Key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">NINBVNPORTAL API URL</label>
                        <div class="">
                        <input type="text" name="ninBvnApiUrl" value="<?php echo $controller->getConfigValue($data[0],"ninBvnApiUrl"); ?>" class="form-control" placeholder="https://ninbvnportal.com.ng/api">
                        </div>
                    </div>

                    <hr>
                    <h4 class="box-title">SMM / Boost Socials API Settings (Megaboost)</h4>
                    <div class="form-group">
                        <label class="control-label">Megaboost API Key</label>
                        <div class="">
                        <input type="text" name="megaboostApiKey" value="<?php echo $controller->getConfigValue($data[0],"megaboostApiKey"); ?>" class="form-control" placeholder="Enter Megaboost API Key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Megaboost API URL</label>
                        <div class="">
                        <input type="text" name="megaboostApiUrl" value="<?php echo $controller->getConfigValue($data[0],"megaboostApiUrl"); ?>" class="form-control" placeholder="https://megaboost.com.ng/api/v1">
                        </div>
                    </div>
