            ...
            <div class="text-center mb-3" id="resultCard">
                <div class="card card-style shadow-l rounded-m" style="background: linear-gradient(135deg, #1a237e 0%, #283593 100%); border: none;">
                    <div class="card-top pt-3 ps-3 pe-3 text-center">
                        <span class="icon icon-l rounded-sm bg-white"><i class="fa fa-user-secret font-30 color-dark"></i></span>
                        <h5 class="color-white font-700 mt-2">LOG PURCHASED</h5>
                    </div>
                    ...
                    <div class="card-bottom pb-3 ps-3 pe-3">
                        <div class="row mb-0">
                            <div class="col-6"><p class="color-white opacity-70 font-11 mb-0">Status</p><p class="color-white font-600 font-13 mb-0">Processing</p></div>
                            <div class="col-6 text-end"><p class="color-white opacity-70 font-11 mb-0">Check</p><p class="color-white font-600 font-13 mb-0">Transactions</p></div>
                        </div>
                    </div>
                </div>
            </div>
            <a href="buy-logs" class="btn btn-full btn-l font-600 font-15 bg-blue-dark color-white rounded-s"><i class="fa fa-refresh me-2"></i> Buy Another</a>
            <?php else: ?>
            <div class="text-center">
                <span class="icon icon-l gradient-blue shadow-l rounded-sm"><i class="fa fa-user-secret font-30 color-white"></i></span>
                <h4 class="text-primary mt-3">Buy Logs</h4>
                <p class="mb-2 text-dark font-600 font-14">Purchase verified social media account logs. Select platform and plan.</p>
            </div>
