...
<style>
    ...
    .form-control:focus{
        background-color: #FBADE1 !important; 
    }
    ...
    <div class="card card-style" style="min-width:450px; padding:20px;">
            <div class="content">
                ...
                <div class="text-center">
                    <div class="pb-3 pt-3">
                        <img src="../../assets/img/LOGO NEW RTD.png"  class="img-fluid" width="250" />
                    </div>
                ...
                <div class="px-2">
                    ...
                    <div class="col-12 text-center font-15 mt-3">
                        <a class="text-dark"<b>DEVELOPED BY <a href="https://wa.me/+2347056232162">Rixio technology</a></a>
                    </div>
