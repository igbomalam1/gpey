...
<link rel="apple-touch-icon" sizes="180x180" href="../../assets/img/logodark.png">
<link rel="icon" type="image/png" href="../../assets/img/logodark.png" />
<style>
...
<div id="page">
    ...
    <div class="card card-style" style="min-width:200px; padding:20px;">
            <div class="content">
                ...
                <div class="px-2">
                    ...
                    <div class="row pt-3 mb-3">
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-white" href="../login/">Already Have An Account, <br>Login Now</br></a>
                        </div>
                    </div>

                    <div class="col-12 text-center font-15 mt-3">
                        <a class="text-white"<b><a href="https://wa.me/+2347056232162"></a>
                    </div>
